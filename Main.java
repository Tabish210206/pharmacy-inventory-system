...
public class Main{
    public static void main(String[] args) {
        ...
        // Create the login button and set style
        ...
        // Positioning the components using setBounds
        ...
        loginButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (validateLogin(username, password)) {
                    ...
                    InventoryDashboard.showInventoryDashboard(username); // Show inventory dashboard
                } else {
